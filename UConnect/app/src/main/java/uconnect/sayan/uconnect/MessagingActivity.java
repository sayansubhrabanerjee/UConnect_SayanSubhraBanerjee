...
public class MessagingActivity extends BaseActivityInstantMessaging
    ...
    private void sendMessage() {
        ...
        if (recipient.isEmpty()) {
            ...
            new DisplayToast().showToast(this,"No recipient added");
            return;
        }
        if (textBody.isEmpty()) {
            //Toast.makeText(this, "No text message", Toast.LENGTH_SHORT).show();
            new DisplayToast().showToast(this,"No text message");
            return;
        }
    ...
    public void onMessageFailed(MessageClient client, Message message,
        ...
        new DisplayToast().showToast(this,sb.toString());
